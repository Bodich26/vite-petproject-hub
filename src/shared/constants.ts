...
export const myFullProjects: IMyFullProjects[] = [
  ...
  },
  {
    ...
    implementation:
      "Проект реализован как full-stack приложение с системой регистрации и авторизации пользователей. Пользователь может просматривать каталог автомобилей, использовать фильтрацию для поиска подходящей модели, добавлять товары в корзину и в избранное. Для каждого автомобиля предусмотрена отдельная страница с подробной информацией. После добавления товара в корзину пользователь может оформить заказ. Оформление и отслеживание заказов доступны только зарегистрированным пользователям. В личном кабинете реализовано отслеживание статуса покупки. Также в приложении поддерживается переключение между светлой и тёмной темой интерфейса (Dark/Light Mode). Для пользователей с правами администратора реализована полноценная административная панель, позволяющая управлять контентом сайта. Дизайн и интерфейс проекта были разработаны самостоятельно.",
    frontend: [
      "Next",
      "Ts",
      "Zustand",
  ...
  },
  {
    ...
    implementation:
      "Проект реализован как Front-End приложение с использованием локальных данных. Основной задачей было глубоко изучить возможности Next.js и сфокусироваться на архитектуре и механике фреймворка, не отвлекаясь на серверную логику. В процессе разработки были проработаны: Различные подходы к рендерингу страниц, Система кэширования и управление кэшем, App Router, Server Actions, Клиентские и серверные компоненты, Оптимизация SEO, Работа с формами с использованием TanStack Form (вместо привычного React Hook Form). На сайте есть админка, для редактирования: Альбомов, Мерча, Туров на странице, но Server Actions ничего не обновляют, так как это локальные данные. Дизайн интерфейса был разработан мной самостоятельно.",
    frontend: [
      "Next",
      "Ts",
      "Tanstack Form",
