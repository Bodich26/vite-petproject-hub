...
export const myFullProjects: IMyFullProjects[] = [
  ...
  },
  {
    ...
    implementation:
      "Проект реализован как Front-End приложение с использованием локальных данных. Основной задачей было глубоко изучить возможности Next.js и сфокусироваться на архитектуре и механике фреймворка, не отвлекаясь на серверную логику. В процессе разработки были проработаны: Различные подходы к рендерингу страниц, Система кэширования и управление кэшем, App Router, Server Actions, Клиентские и серверные компоненты, Оптимизация SEO, Работа с формами с использованием TanStack Form (вместо привычного React Hook Form). На сайте есть админка, для редактирования: Альбомов, Мерча, Туров на странице, но Server Actions ничего не обновляют, так это локальные данные. Дизайн интерфейса был разработан мной самостоятельно.",
    frontend: [
      "Next",
      "Ts",
      "Tanstack Form",
