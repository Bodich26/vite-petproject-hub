...
export const educationAndHobbies: IEducationAndHobbies[] = [
  {
    id: 1,
    name: "Образование",
    text: "Прошёл множество разных курсов по веб-разработке, имею сертификаты. Постоянно повышаю квалификацию, изучаю новые инструменты и применяю знания на практике в своих проектах.",
    image: "1.jpg",
    certificates: [
      {
        name: "JavaScript",
